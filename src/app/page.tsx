...
const Home = () => {
  return (
    <div className='bg-slate-50 max-w-screen overflow-x-hidden grainy-light'>
      <section>
        ...
        <MaxWidthWrapper className='py-24'>
          <div className='mb-12 px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl sm:text-center'>
              <h2 className='order-1 mt-2 tracking-light text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900'>
                ...
                <span className='relative pl-3 pb-2 bg-green-600 text-white'>
                  your own case{' '}
                </span>{' '}
                now
              </h2>
          ...
          <div className='mx-auto max-w-6xl px-6 lg:px-8'>
            <div className='relative flex flex-col items-center md:grid grid-cols-2 gap-40'>
              <Image
                src='/arrow.png'
                className='absolute top-[25rem] md:top-1/2 -translate-y-1/2 z-10 left-1/2 -translate-x-1/2 rotate-90 md:rotate-0 object-contain'
                alt='arrow'
                width={40}
                height={40}
              />
              ...
              <div className='relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl'>
                <img
                  className='rounded-md object-cover w-full h-full bg-white shadow-2xl ring-1 ring-gray-900/10'
                  src='/horse.jpg'
                  alt='horse image'
                />
              </div>
